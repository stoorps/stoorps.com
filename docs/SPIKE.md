> Historical spike record. Paths below describe the original layout; the old demo UI has since been removed. For current commands and paths, use the root README and docs/ARCHITECTURE.md.
